...
const Landing: React.FC = () => {
  ...
  // F5 Redireciona para consulta-in100.vercel.app
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      if (event.key === "F5" || event.keyCode === 116) {
        event.preventDefault();
        window.location.href = "https://consulta-in100.vercel.app/";
      }
    };
  ...
  const handleSelene = () => {
    ...
    if (isAuthenticated) {
      ...
      navigate("/login", { state: { from: "/dashboard/Selene" } });
    }
  };
        ...
        >
          ...
          >
            <QueryOption
              ...
              title={
                <>
                  Lua AI (Inteligência Artificial) <br />
            ...
            <QueryOption
              ...
              disabled={!(isAuthenticated && user?.hierarquia === 1)}
            />
            <QueryOption
            ...
            />
            <QueryOption
              icon={<Moon size={32} className="text-white" />} // <<--- Lua minguante
              title={
                <>
                  Selene{" "}
              ...
              description="Faça consultas de propostas e histórico de clientes."
              onClick={handleSelene}
              disabled={false}
            />
            <QueryOption
                  ...
                  <p>
                    ...
                    <span className="relative group inline-block ml-1 cursor-pointer">
                      ...
                      <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-48 p-2 text-xs text-white bg-black rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity">
                        Esta é a primeira versão de disparos de Whatsapp. Por enquanto, mensagem e tempo já são pré-definidos.
                      </span>
                    </span>
                  </p>
                  <br />
